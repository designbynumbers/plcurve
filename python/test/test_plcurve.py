...
class TestPlCurve(unittest.TestCase):
    ...
    def test_random_generators(self):
        r = RandomGenerator()
        gens = (
            pl.PlCurve.random_closed_polygon,
            pl.PlCurve.random_open_polygon,
            pl.PlCurve.random_closed_plane_polygon,
            pl.PlCurve.random_open_plane_polygon,
            pl.PlCurve.random_equilateral_closed_polygon,
            pl.PlCurve.random_equilateral_open_polygon
        )
        for pl_gen in gens:
