...
/* tangle slide operations d assembled c code */
...
bool pdint_check_tangle_slide_ops_testd() {
...
/*                                                          */
  ...
  printf("--------------------------------------------------\n"
    	 "pdint check tangle slide ops test d\n"
         "--------------------------------------------------\n");

  printf("creating 'before' pd...");
  pd_code_t *pd = pd_create_tangle_slide_operation_testd_before_0();
  if (!pd_ok(pd)) {
  ...
  for(i=0;i<nchildren;i++) {
   ...
   xchildren[0] = pd_create_tangle_slide_operation_testd_after_0();
   xchildren[1] = pd_create_tangle_slide_operation_testd_after_1();
  ...
  printf("--------------------------------------------------------\n"
         "pdint check tangle slide ops testd : PASS\n"
	     "--------------------------------------------------------\n");
...
int main() {
  ...
  if (pdint_check_tangle_slide_ops_testa()&&pdint_check_tangle_slide_ops_testd()) {
