...
int main() {
  ...
  if (pdint_check_tslide_data_ok_and_find_te_testW()&&pdint_check_tslide_data_ok_and_find_te_testa()&&pdint_check_tslide_data_ok_and_find_te_testb()&&pdint_check_tslide_data_ok_and_find_te_testc()&&pdint_check_tslide_data_ok_and_find_te_testd()&&pdint_check_tslide_data_ok_and_find_te_teste()&&pdint_check_tslide_data_ok_and_find_te_testf()&&pdint_check_tslide_data_ok_and_find_te_testg()&&pdint_check_tslide_data_ok_and_find_te_testh()&&pdint_check_tslide_data_ok_and_find_te_testi()) {
