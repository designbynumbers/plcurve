...
\begin{figure}[H]
\hfill
\raisebox{-0.5 \height}{\begin{overpic}[width=1.5in]{proportion-connect-sums.pdf}
\end{overpic}
}
\hfill
\raisebox{-0.5 \height}{
...
\hfill
\hphantom{.}
\caption{Connect sum structure of knot shadows (left, numbers in bars show the number of connect summands), and tree-like 8-crossing shadows (right).}
