...
Cr & Prime Shadows & Link Shadows & Link Diagrams & Knot Shadows & Knot Diagrams \\ \hline
3  & $\num{1}$   & $\num{7}$           & -- & $\num{6}$        & $\num{36}^*$ \\
4  & $\num{2}$   & $\num{30}$          & -- & $\num{19}$       & $\num{276}^*$ \\
5  & $\num{3}$   & $\num{124}$         & -- & $\num{76}$       & $\num{2936}^*$ \\
6  & $\num{9}$   & $\num{733}$         & -- & $\num{376}$      & $\num{35872}^*$ \\
...
The database of diagrams is a large data set, and it would be impractical to point out everything interesting about it. However, it is worth giving an overview of the 
