...
\end{tabular}}
    ...
    \caption{Diagram from Evan-Zohar, Hass, et al.}
    \label{fig:petaluma}
  \end{figure}
\end{frame}
...
\begin{frame}
  \frametitle{Random diagrams}
  \begin{definition}
    A \emph{knot diagram} is a generic embedding of the oriented $S^1$ into
...
\begin{frame}
  ...
  \begin{enumerate}
  \item Enumerate shadows (unoriented graph structure behind
    diagrams).
...
\begin{frame}
  ...
  \begin{columns}
    \begin{column}{.6\columnwidth}
      \includegraphics[width=\columnwidth]{arnold_table.png}\\\hfill\\\hfill\\
...
\begin{frame}
  ...
  Generated table of knot shadows two different ways as a
  check. Both methods use features from McKay and Brinkmann's
  \texttt{plantri}.

  \begin{figure}
    \centering
    \begin{tabular}{ccccc}
      $\vcenter{\hbox{\includegraphics[width=1in]{pre_shadow_graph.pdf}}}$
      & $\Rightarrow$
      & $\vcenter{\hbox{\includegraphics[width=1in]{result_shadow.pdf}}}$
      & $\Leftarrow$
      & $\vcenter{\hbox{\includegraphics[width=1in]{pre_shadow_quads.pdf}}}$
    \end{tabular}
  \end{figure}

  \onslide<2->{Actually generate all \textbf{link shadows}, then
...
\begin{frame}
  ...
  \begin{figure}
    ...
    \caption{$8_{18}$ (left), $9_{40}$ (right).}
    \label{fig:basicpoly}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  A \emph{tree-like curve} is a knot shadow which can be delooped to
  the trivial shadow.
  \begin{figure}
    \centering
    \includegraphics[width=1.5in]{tree_like_8x.pdf}
...
\begin{frame}
  \begin{figure}
    ...
    \begin{tikzpicture}[scale=1]
      \begin{axis}[
        title={Crossing \# vs. Average delooped crossing \#},
        xlabel={\# crossings in diagram},
        ylabel={Average \# crossings in delooped diagram},
        cycle list name=Mark-Set1-9,
        ymin=0, ymax=4,
        ]
...
\begin{frame}
  ...
  \begin{theorem}[Sumners-Wittington]
  ...
  \begin{columns}
    ...
    \begin{tikzpicture}[scale=.5]
      \begin{axis}[
        ...
        \addplot table[x=n,y=\thisrow{3.1c3.1c3.1}*2 +
        \thisrow{3.1c3.1c3.1m}*2 + \thisrow{3.1c3.1mc3.1m}*2] {knot_freq.tsv};
      \end{axis}
    \end{tikzpicture}
    \end{column}
    \begin{column}{.5\columnwidth}
...
\begin{frame}
  ...
  Coming soon: \textit{Knot probabilities in random diagrams}.

  \vfill

  \begin{minipage}[t][.6\textheight]{1.0\linewidth}
    \vfill
    \begin{columns}
      \begin{column}{.1\columnwidth}
        \includegraphics[width=.5\columnwidth]{nsf4.eps}
      \end{column}
      \begin{column}{.9\columnwidth}
