...
\author[Cantarella, Chapman, Mastin]{Harrison Chapman (UGA)\\
joint w/ Jason Cantarella (UGA),\\ Matt Mastin (MailChimp, Inc.)\\
Crucial Assist: Eric Rawdon (St. Thomas)}
\date{AMS Fall Western Section Meeting, 10/24/15}
...
\newcommand{\sr}{/\!\!/}
\newtheorem{observationfirst}[theorem]{Observation}
...
\begin{frame}
  ...
  \begin{definition}
    ...
    $n$-crossing knot diagrams (cf. Dunfield).
  \end{definition}
  \begin{figure}
    \centering
...
\begin{frame}
  ...
  \end{columns}
  \begin{center}
  \includegraphics[width=4in]{../../figs/coqueraux.png}\\
  Coqueraux, Zuber, arxiv:1507.03163
  \end{center}
  \vspace{.3in}
